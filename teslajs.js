  ...
  require("./src/auth").login(
    {
      ...
      mfaPassCode: credentials.mfaPassCode,
      mfaDeviceName: credentials.mfaDeviceName,
    },
 ...
 * @returns {object} result
 */
exports.windowControl = function windowControl(
  options,
  command,
  lat,
  lon,
  ...
  post_command(
    ...
    { command: command, lat: lat || 0, lon: lon || 0 },
    callback
  );
};
 ...
 * @returns {object} result
 */
exports.setScheduledCharging = function setScheduledCharging(
  options,
  enable,
  time,
  callback
 ...
 * @returns {Promise} result
 */
exports.setScheduledChargingAsync = Promise.denodeify(
  exports.setScheduledCharging
);
 ...
 * @returns {object} result
 */
exports.setScheduledDeparture = function setScheduledDeparture(
  options,
  enable,
  departure_time,
 ...
 * @returns {Promise} result
 */
exports.setScheduledDepartureAsync = Promise.denodeify(
  exports.setScheduledDeparture
);
...
exports.solarStatus = function solarStatus(options, callback) {
  ...
  var req = {
    method: "GET",
    url:
      portalBaseURI + "/api/1/energy_sites/" + options.siteId + "/live_status",
    headers: {
      Authorization: "Bearer " + options.authToken,
      "Content-Type": "application/json; charset=utf-8",
    },
